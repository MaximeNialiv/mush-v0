...
// Étendre les props pour ajouter l'option hideCloseButton et description
...
>(({ className, children, hideCloseButton = false, description, ...props }, ref) => {
  // Créer une copie des props sans la propriété onOpenChange pour empêcher la fermeture
  const dialogProps = { ...props };
  if (hideCloseButton && 'onOpenChange' in dialogProps) {
    delete dialogProps.onOpenChange;
  }
  
  // Générer un ID unique pour aria-describedby s'il n'est pas fourni
